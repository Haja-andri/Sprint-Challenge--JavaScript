...
console.log('The weight of the tyrannosaurus is ' + tyrannosaurus.weight);

// What was the diet of a velociraptor?
console.log('The diet of a velociraptor is ' + velociraptor.diet);

// How long was a stegosaurus?
console.log('The stegosaurus is ' + stegosaurus.length + ' length');

// What time period did tyrannosaurus live in?
console.log('The tyrannosaurus lived during ' + tyrannosaurus.period);
...
for (let i = 0; i < universities.length; i++){
  let uniName = universities[i];
  if(uniName.includes('Uni')){
    uni.push(uniName);
  }
}
console.log(uni);
...
*/
const animalNames = [];
zooAnimals.forEach(elements =>{
  animalNames.push('Name: ' + elements.animal_name + ' Scientific: ' + elements.scientific_name)
} )
...
*/
const populationTotal = zooAnimals.reduce((total,annimal) =>{
  return total += annimal.population;
}, 0);
